...
void GameObject::Union() { mApplication->Union(this); }

void GameObject::Intersection() { mApplication->Intersection(this); }

void GameObject::Subtract() { mApplication->Subtract(this); }

void GameObject::Destroy() { mApplication->DestroyGameObject(this); }
...
Quaternion Transform::GetRotation() { return mRotation; }
...
void Transform::SetRotationEuler(const Vector3& rotationEuler)
{
    ...
    mRotation =
    Math::ToQuaternion(Math::EulerAngles(angles, Math::EulerOrders::XYZs));
    mOwner->TransformUpdate(TransformUpdateFlags::Rotation);
}

Vector3 Transform::GetTranslation() { return mTranslation; }
...
//-----------------------------------------------------------------------------SimpleMover
SimpleMover::SimpleMover() { mTotalTime = 0; }
