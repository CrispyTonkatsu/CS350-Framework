...
public:
    ...
    // These functions allow chaining of setting properties (C++ closest thing
    // to named parameters)
    ...
    // Set a random bit on the mask which can control what is drawn with the
    // number keys.
...
public:
    ...
    DebugShape& DrawQuad(const Vector3& p0, const Vector3& p1,
...
private:
    ...
    using DebugShapeList = std::vector<DebugShape>;
