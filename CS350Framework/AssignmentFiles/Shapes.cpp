...
Matrix3 ComputeJacobiRotation(const Matrix3 &matrix) {
  ...
  // off-diagonal element of the input matrix into zero. Note: the input matrix
  // should always be (near) symmetric.
  Warn("Assignment2: Required function un-implemented");
  return Matrix3::cIdentity;
}
...
void Sphere::ComputeCentroid(const std::vector<Vector3> &points) {
  /******Student:Assignment2******/
  // The centroid method is roughly describe as: find the centroid (not mean) of
  // all points and then find the furthest away point from the centroid.
  Warn("Assignment2: Required function un-implemented");
}
...
void Sphere::ComputePCA(const std::vector<Vector3> &points) {
  // The PCA method:
  // Compute the eigen values and vectors. Take the largest eigen vector as the
  // axis of largest spread. Compute the sphere center as the center of this
  // axis then expand by all points.
  /******Student:Assignment2******/
  Warn("Assignment2: Required function un-implemented");
}
...
void Aabb::Transform(const Vector3 &scale, const Matrix3 &rotation,
  ...
  // You should use the optimize method discussed in class (not transforming all
  // 8 points).
  Warn("Assignment2: Required function un-implemented");
}
...
void Plane::Set(const Vector3 &p0, const Vector3 &p1, const Vector3 &p2) {
  /******Student:Assignment1******/
  // Set mData from the 3 points. Note: You should most likely normalize the
  // plane normal.
...
void Plane::Set(const Vector3 &normal, const Vector3 &point) {
  /******Student:Assignment1******/
  // Set mData from the normal and point. Note: You should most likely normalize
  // the plane normal.
  Warn("Assignment1: Required function un-implemented");
}
