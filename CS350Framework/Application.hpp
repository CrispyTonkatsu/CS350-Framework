...
// Simple statistics of frame-rate, how many collision tests, etc... are run
// both for you to use as a sanity check and for me to use for unit
// tests/drivers.
struct Statistics
{
    Statistics();
    ...
    // Basically how many pairs would normally go to narrow-phase (collision
    // detection).
...
public:
    ...
    void LoadMesh(const std::string& path, const std::string& meshName,
    ...
    void FindPotentialIntersections(GameObject* gameObject,
