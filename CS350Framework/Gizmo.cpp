...
TranslationGizmo::TranslationGizmo() { mCaptured = false; }
...
bool TranslationGizmo::OnMouseInput(Application* application,
                                    ...
                                    const Ray& ray)
{
    ...
    float tX, tY, tZ;
    bool resultX =
    Helpers::RayCylinder(ray.mStart, ray.mDirection, pos,
                         pos + cylinderLength * basisX, cylinderRadius, tX);
    bool resultY =
    Helpers::RayCylinder(ray.mStart, ray.mDirection, pos,
                         pos + cylinderLength * basisY, cylinderRadius, tY);
    bool resultZ =
    Helpers::RayCylinder(ray.mStart, ray.mDirection, pos,
                         pos + cylinderLength * basisZ, cylinderRadius, tZ);
