...
public:
    ...
    void Select(GameObject* object) { mSelectedObject = object; }

    virtual void OnUpdate(Application* application, float dt) = 0;
    virtual bool OnMouseInput(Application* application, unsigned int button,
                              bool isDown, const Ray& ray) = 0;
    ...
    void GetBasis(Vector3& pos, Vector3& basisX, Vector3& basisY,
                  Vector3& basisZ);
};
...
public:
    ...
    bool OnMouseInput(Application* application, unsigned int button,
                      bool isDown, const Ray& ray) override;
