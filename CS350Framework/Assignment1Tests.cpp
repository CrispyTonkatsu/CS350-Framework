...
void TestBarycentricLine(const Vector3& p0, const Vector3& p1, float expectedU,
                         float expectedV, FILE* outFile)
{
    float epsilon = 0.05f;
...
void TestBarycentricTriangle(const Vector3& p0, const Vector3& p1,
                             const Vector3& p2, float expectedU,
                             float expectedV, float expectedW, FILE* outFile)
{
    float epsilon = 0.05f;
...
void TestPlaneSet(const Vector3& pointA, const Vector3& pointB,
                  const Vector3& pointC, FILE* outFile)
{
    Plane plane;
...
void TestPointPlane(const Vector3& point, const Plane& plane, float epsilon,
                    FILE* outFile)
{
...
void TestProjectPointOnPlane(const Vector3& point, const Plane& plane,
                             FILE* outFile)
{
    Vector3 result =
...
void TestPlaneSphere(const Plane& plane, const Sphere& sphere, FILE* outFile)
{
    ...
    ProjectPointOnPlane(sphere.mCenter, plane.GetNormal(), plane.GetDistance());
...
void TestPlaneTriangle(const Plane& plane, const Triangle& tri, float epsilon,
                       FILE* outFile)
{
...
void TestSphereSphere(const Sphere& sphere0, const Sphere& sphere1,
                      FILE* outFile)
{
...
void TestFrustumTriangle(const Frustum& frustum, const Triangle& tri,
                         FILE* outFile)
{
...
void TestFrustumSphere(const Frustum& frustum, const Sphere& sphere,
                       FILE* outFile)
{
    size_t axis = 0;
    IntersectionType::Type result =
                              ...
                              FILE* file = nullptr)
{
    ...
    auto point = Vector3(1, 2.41421f, 0);
                               ...
                               FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.70711f, 1.70711f, 1);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                               ...
                               FILE* file = nullptr)
{
    ...
    auto point = Vector3(-0.414214f, 1, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                               ...
                               FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.292893f, 0.292893f, 1);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                               ...
                               FILE* file = nullptr)
{
    ...
    auto point = Vector3(2.41421f, 1, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                               ...
                               FILE* file = nullptr)
{
    ...
    auto point = Vector3(1, -0.414214f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                          ...
                          FILE* file = nullptr)
{
    ...
    auto p0 = Vector3(-1, -1, -1);
    auto p1 = Vector3(1, 1, 1);
    float u = 0;
    float v = 1;
                           ...
                           FILE* file = nullptr)
{
    ...
    auto p0 = Vector3(0, -2, 0);
    auto p1 = Vector3(0, 2, 0);
    float u = 0;
    float v = 1;
                           ...
                           FILE* file = nullptr)
{
    ...
    auto p0 = Vector3(-1, -2, -3);
    auto p1 = Vector3(1, 2, 3);
    float u = 0;
    float v = 1;
                           ...
                           FILE* file = nullptr)
{
    ...
    auto p0 = Vector3(-2, 0, 0);
    auto p1 = Vector3(2, 0, 0);
    float u = 0;
    float v = 1;
                           ...
                           FILE* file = nullptr)
{
    ...
    auto p0 = Vector3(0, 0, -2);
    auto p1 = Vector3(0, 0, 2);
    float u = 0;
    float v = 1;
                               ...
                               FILE* file = nullptr)
{
    ...
    auto p0 = Vector3(1, 0, -1);
    auto p1 = Vector3(1, 0, 1);
    auto p2 = Vector3(-1, 0, 0);
    float u = 0.33f;
    float v = 0.33f;
    float w = 0.33f;
                   ...
                   FILE* file = nullptr)
{
    ...
    auto pointA = Vector3(-1, 0, 0);
    auto pointB = Vector3(0, 1, 0);
    auto pointC = Vector3(1, 0, 0);
                   ...
                   FILE* file = nullptr)
{
    ...
    auto pointA = Vector3(0, 0, 0);
    auto pointB = Vector3(-1, -10, -1);
    auto pointC = Vector3(1, -10, -1);
    TestPlaneSet(pointA, pointB, pointC, file);
}
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(0.292893f, 1.70711f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(0.46967f, 1.88388f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(0.116116f, 1.53033f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(1.70711f, 0.292893f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(1.88388f, 0.46967f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(1.53033f, 0.116116f, 0);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(1.17678f, 1.17678f, 1);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                      ...
                      FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    auto point = Vector3(0.823223f, 0.823223f, 1);
    Plane plane(Vector3(0.707107f, 0.707107f, 0), Vector3(1, 1, 0));
                       ...
                       FILE* file = nullptr)
{
    ...
    auto point = Vector3(2.73205f, 3.73205f, 4.73205f);
    Sphere sphere(Vector3(1, 2, 3), 1.5f);
                       ...
                       FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.86603f, 2.86603f, 3.86603f);
    Sphere sphere(Vector3(1, 2, 3), 1.5f);
                       ...
                       FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.43301f, 2.43301f, 3.43301f);
    Sphere sphere(Vector3(1, 2, 3), 1.5f);
                       ...
                       FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.57735f, 0.57735f, 0.57735f);
    Sphere sphere(Vector3(0, 0, 0), 0.5f);
                       ...
                       FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.288675f, 0.288675f, 0.288675f);
    Sphere sphere(Vector3(0, 0, 0), 0.5f);
                       ...
                       FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.144338f, 0.144338f, 0.144338f);
    Sphere sphere(Vector3(0, 0, 0), 0.5f);
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.5f, 0.5f, 0.5f);
    Aabb aabb(Vector3(-0.5f, -0.5f, -0.5f), Vector3(0.5f, 0.5f, 0.5f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.25f, 0.25f, 0.25f);
    Aabb aabb(Vector3(-0.5f, -0.5f, -0.5f), Vector3(0.5f, 0.5f, 0.5f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.2f, 6, 4.4f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.1f, 4, 3.7f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.05f, 3, 3.35f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.95f, 1, 2.65f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.9f, 0, 2.3f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.8f, -2, 1.6f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.2f, 6, 1.6f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.1f, 4, 2.3f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.05f, 3, 2.65f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.95f, 1, 3.35f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.9f, 0, 3.7f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.8f, -2, 4.4f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.2f, -2, 1.6f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.1f, 0, 2.3f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.05f, 1, 2.65f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.95f, 3, 3.35f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.9f, 4, 3.7f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.8f, 6, 4.4f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.2f, -2, 4.4f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.1f, 0, 3.7f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(1.05f, 1, 3.35f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.95f, 3, 2.65f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.9f, 4, 2.3f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                     ...
                     FILE* file = nullptr)
{
    ...
    auto point = Vector3(0.8f, 6, 1.6f);
    Aabb aabb(Vector3(0.9f, 0, 2.3f), Vector3(1.1f, 4, 3.7f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-3.70711f, -2.29289f, -3),
            Vector3(-0.707107f, 0.707107f, 0));
    Plane plane(Vector3(1, 1, 1), Vector3(0, 0, 0));
                    ...
                    FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(2.29289f, 3.70711f, 3),
                    ...
                    FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-2.29289f, -2.70711f, -3),
            Vector3(0.707107f, -0.707107f, 0));
    Plane plane(Vector3(-1, -1, -1), Vector3(0, 1, 0));
                    ...
                    FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(3.70711f, 3.29289f, 3),
            Vector3(-0.408248f, -0.408248f, 0.816497f));
    Plane plane(Vector3(-1, -1, -1), Vector3(0, 1, 0));
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-4.7735f, -6.7735f, -5.7735f),
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-5.24491f, -6.3021f, -5.7735f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(6.7735f, 4.7735f, 5.7735f),
            Vector3(-0.57735f, -0.57735f, -0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-6.17357f, -5.37343f, -5.7735f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-3.37343f, -8.17357f, -5.7735f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-5.58183f, -7.58183f, -4.15684f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-3.96517f, -5.96517f, -7.39017f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-17.1288f, -19.1288f, -15.7038f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(17.5122f, 15.5122f, 18.9372f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-15.5122f, -17.5122f, -18.9372f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(19.1288f, 17.1288f, 15.7038f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(2.63299f, 0.632993f, -3.26599f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(7.24491f, 4.3021f, 5.7735f),
            Vector3(-0.57735f, -0.57735f, -0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(8.17357f, 3.37343f, 5.7735f),
            Vector3(-0.57735f, -0.57735f, -0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(5.37343f, 6.17357f, 5.7735f),
            Vector3(-0.57735f, -0.57735f, -0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(5.96517f, 3.96517f, 7.39017f),
            Vector3(-0.57735f, -0.57735f, -0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                     ...
                     FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(7.58183f, 5.58183f, 4.15684f),
            Vector3(-0.57735f, -0.57735f, -0.57735f));
    Sphere sphere(Vector3(1, -1, 0), 2);
                   ...
                   FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-3.33333f, -3.33333f, 0.666667f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Aabb aabb(Vector3(-1, -1, -1), Vector3(1, 1, 1));
                   ...
                   FILE* file = nullptr)
{
    ...
    Ray ray(Vector3(-0.666667f, -0.666667f, -4.66667f),
            Vector3(0.57735f, 0.57735f, 0.57735f));
    Aabb aabb(Vector3(-1, -1, -1), Vector3(1, 1, 1));
                        ...
                        FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.707107f, 0, -0.707107f),
                Vector3(1.35355f, -0, 1.35355f));
    Triangle tri(Vector3(1, 0, -1), Vector3(1, 0, 1), Vector3(-1, 0, 0));
                        ...
                        FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0.948683f, 0, -0.316228f),
                Vector3(-1.37434f, 0, 0.458114f));
    Triangle tri(Vector3(1, 0, -1), Vector3(1, 0, 1), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, 0, 0.992278f),
                Vector3(0.200479f, -0, -1.60383f));
    Triangle tri(Vector3(1, 0, -1), Vector3(1, 0, 1), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, 0, 0.992278f),
                Vector3(0.0826459f, -0, -0.661167f));
    Triangle tri(Vector3(1, 0, -1), Vector3(1, 0, 1), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, 0, 0.992278f),
                Vector3(0.0307692f, -0, -0.246154f));
    Triangle tri(Vector3(1, 0, -1), Vector3(1, 0, 1), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, 0, 0.992278f),
                Vector3(-0.0518767f, 0, 0.415013f));
    Triangle tri(Vector3(1, 0, -1), Vector3(1, 0, 1), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0, 0.707107f, 0.707107f),
                Vector3(-0, -1.35355f, -1.35355f));
    Triangle tri(Vector3(0, 1, -1), Vector3(0, -1, -1), Vector3(0, 0, 1));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0, 0.316228f, -0.948683f),
                Vector3(0, -0.458114f, 1.37434f));
    Triangle tri(Vector3(0, 1, -1), Vector3(0, -1, -1), Vector3(0, 0, 1));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0, -0.992278f, 0.124035f),
                Vector3(-0, 1.60383f, -0.200479f));
    Triangle tri(Vector3(0, 1, -1), Vector3(0, -1, -1), Vector3(0, 0, 1));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0, -0.992278f, 0.124035f),
                Vector3(-0, 0.661167f, -0.0826459f));
    Triangle tri(Vector3(0, 1, -1), Vector3(0, -1, -1), Vector3(0, 0, 1));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0, -0.992278f, 0.124035f),
                Vector3(-0, 0.246154f, -0.0307692f));
    Triangle tri(Vector3(0, 1, -1), Vector3(0, -1, -1), Vector3(0, 0, 1));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0, -0.992278f, 0.124035f),
                Vector3(0, -0.415013f, 0.0518767f));
    Triangle tri(Vector3(0, 1, -1), Vector3(0, -1, -1), Vector3(0, 0, 1));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.707107f, 0.707107f, 0),
                Vector3(1.35355f, -1.35355f, -0));
    Triangle tri(Vector3(1, 1, 0), Vector3(1, -1, 0), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(0.948683f, 0.316228f, 0),
                Vector3(-1.37434f, -0.458114f, 0));
    Triangle tri(Vector3(1, 1, 0), Vector3(1, -1, 0), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, -0.992278f, 0),
                Vector3(0.200479f, 1.60383f, -0));
    Triangle tri(Vector3(1, 1, 0), Vector3(1, -1, 0), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, -0.992278f, 0),
                Vector3(0.0826459f, 0.661167f, -0));
    Triangle tri(Vector3(1, 1, 0), Vector3(1, -1, 0), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, -0.992278f, 0),
                Vector3(0.0307692f, 0.246154f, -0));
    Triangle tri(Vector3(1, 1, 0), Vector3(1, -1, 0), Vector3(-1, 0, 0));
                         ...
                         FILE* file = nullptr)
{
    ...
    float epsilon = 0.5f;
    Plane plane(Vector3(-0.124035f, -0.992278f, 0),
                Vector3(-0.0518767f, -0.415013f, 0));
    Triangle tri(Vector3(1, 1, 0), Vector3(1, -1, 0), Vector3(-1, 0, 0));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, 0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.125f, -0.125f, -0.125f),
              Vector3(0.875f, 0.875f, 0.875f));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, 0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.875f, -0.875f, -0.875f),
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, -0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.125f, -0.125f, -0.875f),
              Vector3(0.875f, 0.875f, 0.125f));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, -0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.875f, -0.875f, -0.125f),
              Vector3(0.125f, 0.125f, 0.875f));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, 0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.125f, -0.875f, -0.125f),
              Vector3(0.875f, 0.125f, 0.875f));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, 0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.875f, -0.125f, -0.875f),
              Vector3(0.125f, 0.875f, 0.125f));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, -0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.125f, -0.875f, -0.875f),
              Vector3(0.875f, 0.125f, 0.125f));
                     ...
                     FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, -0.57735f), Vector3(0, 0, 0));
    Aabb aabb(Vector3(-0.875f, -0.125f, -0.125f),
              Vector3(0.125f, 0.875f, 0.875f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Aabb aabb(Vector3(1.23333f, 2.23333f, 3.63333f),
              Vector3(2.23333f, 3.23333f, 3.83333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.903333f, 1.90333f, 3.30333f),
              Vector3(1.90333f, 2.90333f, 3.50333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.0966667f, 1.09667f, 2.49667f),
              Vector3(1.09667f, 2.09667f, 2.69667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(-0.233333f, 0.766667f, 2.16667f),
              Vector3(0.766667f, 1.76667f, 2.36667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(1.23333f, 2.23333f, 2.16667f),
              Vector3(2.23333f, 3.23333f, 2.36667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.903333f, 1.90333f, 2.49667f),
              Vector3(1.90333f, 2.90333f, 2.69667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.0966667f, 1.09667f, 3.30333f),
              Vector3(1.09667f, 2.09667f, 3.50333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, 0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(-0.233333f, 0.766667f, 3.63333f),
              Vector3(0.766667f, 1.76667f, 3.83333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(1.23333f, 0.766667f, 3.63333f),
              Vector3(2.23333f, 1.76667f, 3.83333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.903333f, 1.09667f, 3.30333f),
              Vector3(1.90333f, 2.09667f, 3.50333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.0966667f, 1.90333f, 2.49667f),
              Vector3(1.09667f, 2.90333f, 2.69667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, 0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(-0.233333f, 2.23333f, 2.16667f),
              Vector3(0.766667f, 3.23333f, 2.36667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(1.23333f, 0.766667f, 2.16667f),
              Vector3(2.23333f, 1.76667f, 2.36667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.903333f, 1.09667f, 2.49667f),
              Vector3(1.90333f, 2.09667f, 2.69667f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(0.0966667f, 1.90333f, 3.30333f),
              Vector3(1.09667f, 2.90333f, 3.50333f));
                      ...
                      FILE* file = nullptr)
{
    ...
    Plane plane(Vector3(0.57735f, -0.57735f, -0.57735f), Vector3(1, 2, 3));
    Aabb aabb(Vector3(-0.233333f, 2.23333f, 3.63333f),
              Vector3(0.766667f, 3.23333f, 3.83333f));
                          ...
                          FILE* file = nullptr)
{
    ...
    Frustum frustum;
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                Vector3(7.66308f, -7.66308f, 5), Vector3(7.66308f, 7.66308f, 5),
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 1, 0), Vector3(0.866025f, -0.5f, 0),
                      Vector3(-0.866025f, -0.5f, 0));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(5.33154f, 0, -1), Vector3(6.19756f, 0, 0.5f),
                      Vector3(4.46551f, 0, 0.5f));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(7.33154f, 0, -1), Vector3(8.19756f, 0, 0.5f),
                      Vector3(6.46551f, 0, 0.5f));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(-5.33154f, 0, 1), Vector3(-4.46551f, 0, -0.5f),
                      Vector3(-6.19756f, 0, -0.5f));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(-7.33154f, 0, 1), Vector3(-6.46551f, 0, -0.5f),
                      Vector3(-8.19756f, 0, -0.5f));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 6.33154f, 0), Vector3(0.866025f, 4.83154f, 0),
                      Vector3(-0.866025f, 4.83154f, 0));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 8.33154f, 0), Vector3(0.866025f, 6.83154f, 0),
                      Vector3(-0.866025f, 6.83154f, 0));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -6.33154f, 0),
                      Vector3(0.866025f, -4.83154f, 0),
                      Vector3(-0.866025f, -4.83154f, 0));
                          ...
                          FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -8.33154f, 0),
                      Vector3(0.866025f, -6.83154f, 0),
                      Vector3(-0.866025f, -6.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 1, 5), Vector3(0, -0.5f, 4.13397f),
                      Vector3(0, -0.5f, 5.86603f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 1, 7), Vector3(0, -0.5f, 6.13397f),
                      Vector3(0, -0.5f, 7.86603f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -1, -5), Vector3(0, 0.5f, -5.86603f),
                      Vector3(0, 0.5f, -4.13397f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -1, -7), Vector3(0, 0.5f, -7.86603f),
                      Vector3(0, 0.5f, -6.13397f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(5.33154f, 15.9946f, -1),
                      Vector3(6.19756f, 15.9946f, 0.5f),
                      Vector3(4.46551f, 15.9946f, 0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(5.33154f, 0, 14), Vector3(6.19756f, 0, 15.5f),
                      Vector3(4.46551f, 0, 15.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(5.33154f, 0, -16), Vector3(6.19756f, 0, -14.5f),
                      Vector3(4.46551f, 0, -14.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(-5.33154f, 0, 14), Vector3(-4.46551f, 0, 15.5f),
                      Vector3(-6.19756f, 0, 15.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(-5.33154f, 0, -16), Vector3(-4.46551f, 0, -14.5f),
                      Vector3(-6.19756f, 0, -14.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 6.33154f, 15),
                      Vector3(0.866025f, 4.83154f, 15),
                      Vector3(-0.866025f, 4.83154f, 15));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(15.9946f, 6.33154f, 0),
                      Vector3(16.8606f, 4.83154f, 0),
                      Vector3(15.1286f, 4.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -4.33154f, 15),
                      Vector3(0.866025f, -5.83154f, 15),
                      Vector3(-0.866025f, -5.83154f, 15));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(15.9946f, -4.33154f, 0),
                      Vector3(16.8606f, -5.83154f, 0),
                      Vector3(15.1286f, -5.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(15.9946f, 1, 5),
                      Vector3(15.9946f, -0.5f, 4.13397f),
                      Vector3(15.9946f, -0.5f, 5.86603f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 16.9946f, 5), Vector3(0, 15.4946f, 4.13397f),
                      Vector3(0, 15.4946f, 5.86603f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -14.9946f, 5), Vector3(0, -16.4946f, 4.13397f),
                      Vector3(0, -16.4946f, 5.86603f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, 16.9946f, -5), Vector3(0, 15.4946f, -5.86603f),
                      Vector3(0, 15.4946f, -4.13397f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Triangle triangle(Vector3(0, -14.9946f, -5),
                      Vector3(0, -16.4946f, -5.86603f),
                      Vector3(0, -16.4946f, -4.13397f));
                           ...
                           FILE* file = nullptr)
{
    ...
    Frustum frustum;
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                Vector3(5, 7.66308f, -7.66308f), Vector3(5, 7.66308f, 7.66308f),
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, 1, 0), Vector3(0, -0.5f, -0.866025f),
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, 1, 5.33154f), Vector3(0, -0.5f, 4.46551f),
                      Vector3(0, -0.5f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, 1, 7.33154f), Vector3(0, -0.5f, 6.46551f),
                      Vector3(0, -0.5f, 8.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, -1, -5.33154f), Vector3(0, 0.5f, -6.19756f),
                      Vector3(0, 0.5f, -4.46551f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, -1, -7.33154f), Vector3(0, 0.5f, -8.19756f),
                      Vector3(0, 0.5f, -6.46551f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(5, 0, -1), Vector3(5.86603f, 0, 0.5f),
                      Vector3(4.13397f, 0, 0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(7, 0, -1), Vector3(7.86603f, 0, 0.5f),
                      Vector3(6.13397f, 0, 0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-5, 0, 1), Vector3(-4.13397f, 0, -0.5f),
                      Vector3(-5.86603f, 0, -0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-7, 0, 1), Vector3(-6.13397f, 0, -0.5f),
                      Vector3(-7.86603f, 0, -0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, 6.33154f, 15.9946f),
                      Vector3(0.866025f, 4.83154f, 15.9946f),
                      Vector3(-0.866025f, 4.83154f, 15.9946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(15, 6.33154f, 0), Vector3(15.866f, 4.83154f, 0),
                      Vector3(14.134f, 4.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-15, 6.33154f, 0), Vector3(-14.134f, 4.83154f, 0),
                      Vector3(-15.866f, 4.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, -4.33154f, 15.9946f),
                      Vector3(0.866025f, -5.83154f, 15.9946f),
                      Vector3(-0.866025f, -5.83154f, 15.9946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(15, -4.33154f, 0), Vector3(15.866f, -5.83154f, 0),
                      Vector3(14.134f, -5.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-15, -4.33154f, 0),
                      Vector3(-14.134f, -5.83154f, 0),
                      Vector3(-15.866f, -5.83154f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(15, 1, 5.33154f), Vector3(15, -0.5f, 4.46551f),
                      Vector3(15, -0.5f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, 16.9946f, 5.33154f),
                      Vector3(0, 15.4946f, 4.46551f),
                      Vector3(0, 15.4946f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(0, -14.9946f, 5.33154f),
                      Vector3(0, -16.4946f, 4.46551f),
                      Vector3(0, -16.4946f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(15, 1, -5.33154f), Vector3(15, -0.5f, -6.19756f),
                      Vector3(15, -0.5f, -4.46551f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-15, 1, -5.33154f),
                      Vector3(-15, -0.5f, -6.19756f),
                      Vector3(-15, -0.5f, -4.46551f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(5, 15.9946f, -1),
                      Vector3(5.86603f, 15.9946f, 0.5f),
                      Vector3(4.13397f, 15.9946f, 0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(5, 0, 14.9946f), Vector3(5.86603f, 0, 16.4946f),
                      Vector3(4.13397f, 0, 16.4946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(5, 0, -16.9946f), Vector3(5.86603f, 0, -15.4946f),
                      Vector3(4.13397f, 0, -15.4946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-5, 0, 14.9946f), Vector3(-4.13397f, 0, 16.4946f),
                      Vector3(-5.86603f, 0, 16.4946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Triangle triangle(Vector3(-5, 0, -16.9946f),
                      Vector3(-4.13397f, 0, -15.4946f),
                      Vector3(-5.86603f, 0, -15.4946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    Frustum frustum;
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                Vector3(-7.66308f, 5, 7.66308f), Vector3(7.66308f, 5, 7.66308f),
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, 0, -1), Vector3(0.866025f, 0, 0.5f),
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, 6, 0), Vector3(0.866025f, 4.5f, 0),
                      Vector3(-0.866025f, 4.5f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, 8, 0), Vector3(0.866025f, 6.5f, 0),
                      Vector3(-0.866025f, 6.5f, 0));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(15.9946f, 1, 5.33154f),
                      Vector3(15.9946f, -0.5f, 4.46551f),
                      Vector3(15.9946f, -0.5f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, 16, 5.33154f), Vector3(0, 14.5f, 4.46551f),
                      Vector3(0, 14.5f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, -14, 5.33154f), Vector3(0, -15.5f, 4.46551f),
                      Vector3(0, -15.5f, 6.19756f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, 16, -5.33154f), Vector3(0, 14.5f, -6.19756f),
                      Vector3(0, 14.5f, -4.46551f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, -14, -5.33154f), Vector3(0, -15.5f, -6.19756f),
                      Vector3(0, -15.5f, -4.46551f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(5.33154f, 15, -1), Vector3(6.19756f, 15, 0.5f),
                      Vector3(4.46551f, 15, 0.5f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(5.33154f, 0, 14.9946f),
                      Vector3(6.19756f, 0, 16.4946f),
                      Vector3(4.46551f, 0, 16.4946f));
                           ...
                           FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(5.33154f, 0, -16.9946f),
                      Vector3(6.19756f, 0, -15.4946f),
                      Vector3(4.46551f, 0, -15.4946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(-5.33154f, 15, -1), Vector3(-4.46551f, 15, 0.5f),
                      Vector3(-6.19756f, 15, 0.5f));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(-5.33154f, -15, -1),
                      Vector3(-4.46551f, -15, 0.5f),
                      Vector3(-6.19756f, -15, 0.5f));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, 6, 15.9946f),
                      Vector3(0.866025f, 4.5f, 15.9946f),
                      Vector3(-0.866025f, 4.5f, 15.9946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(15.9946f, 6, 0), Vector3(16.8606f, 4.5f, 0),
                      Vector3(15.1286f, 4.5f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(-15.9946f, 6, 0), Vector3(-15.1286f, 4.5f, 0),
                      Vector3(-16.8606f, 4.5f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(0, -4, 15.9946f),
                      Vector3(0.866025f, -5.5f, 15.9946f),
                      Vector3(-0.866025f, -5.5f, 15.9946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(15.9946f, -4, 0), Vector3(16.8606f, -5.5f, 0),
                      Vector3(15.1286f, -5.5f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Triangle triangle(Vector3(-15.9946f, -4, 0), Vector3(-15.1286f, -5.5f, 0),
                      Vector3(-16.8606f, -5.5f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Frustum frustum;
    frustum.Set(
    Vector3(4.76837e-07f, -10.8372f, 5), Vector3(10.8372f, -4.76837e-07f, 5),
    Vector3(-4.76837e-07f, 10.8372f, 5), Vector3(-10.8372f, 4.76837e-07f, 5),
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(0, 1, 0), Vector3(0.866025f, -0.5f, 0),
                      Vector3(-0.866025f, -0.5f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(3.06286f, 3.06286f, 0),
                      Vector3(4.12352f, 4.12352f, -0.866025f),
                      Vector3(4.12352f, 4.12352f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(4.47707f, 4.47707f, 0),
                      Vector3(5.53773f, 5.53773f, -0.866025f),
                      Vector3(5.53773f, 5.53773f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-3.76997f, 4.76997f, 0),
                      Vector3(-2.90394f, 3.26997f, 0),
                      Vector3(-4.63599f, 3.26997f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-5.18418f, 6.18418f, 0),
                      Vector3(-4.31816f, 4.68418f, 0),
                      Vector3(-6.05021f, 4.68418f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-0.707107f, 0.707107f, 5),
                      Vector3(0.353553f, -0.353553f, 4.13397f),
                      Vector3(0.353553f, -0.353553f, 5.86603f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-0.707107f, 0.707107f, 7),
                      Vector3(0.353553f, -0.353553f, 6.13397f),
                      Vector3(0.353553f, -0.353553f, 7.86603f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-8.24704f, 14.3728f, 0),
                      Vector3(-7.18638f, 15.4334f, -0.866025f),
                      Vector3(-7.18638f, 15.4334f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(3.06286f, 3.06286f, 15),
                      Vector3(4.12352f, 4.12352f, 14.134f),
                      Vector3(4.12352f, 4.12352f, 15.866f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(14.3728f, -8.24704f, 0),
                      Vector3(15.4334f, -7.18638f, -0.866025f),
                      Vector3(15.4334f, -7.18638f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-15.787f, 6.83283f, 0),
                      Vector3(-14.7263f, 7.89349f, -0.866025f),
                      Vector3(-14.7263f, 7.89349f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-4.47707f, -4.47707f, 15),
                      Vector3(-3.41641f, -3.41641f, 14.134f),
                      Vector3(-3.41641f, -3.41641f, 15.866f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(6.83283f, -15.787f, 0),
                      Vector3(7.89349f, -14.7263f, -0.866025f),
                      Vector3(7.89349f, -14.7263f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-3.76997f, 4.76997f, 15),
                      Vector3(-2.90394f, 3.26997f, 15),
                      Vector3(-4.63599f, 3.26997f, 15));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(7.53993f, 16.0799f, 0),
                      Vector3(8.40596f, 14.5799f, 0),
                      Vector3(6.67391f, 14.5799f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-15.0799f, -6.53993f, 0),
                      Vector3(-14.2138f, -8.03993f, 0),
                      Vector3(-15.9459f, -8.03993f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(3.76997f, -2.76997f, 15),
                      Vector3(4.63599f, -4.26997f, 15),
                      Vector3(2.90394f, -4.26997f, 15));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(15.0799f, 8.53993f, 0),
                      Vector3(15.9459f, 7.03993f, 0),
                      Vector3(14.2138f, 7.03993f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-7.53993f, -14.0799f, 0),
                      Vector3(-6.67391f, -15.5799f, 0),
                      Vector3(-8.40596f, -15.5799f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(10.6028f, 12.017f, 5),
                      Vector3(11.6635f, 10.9563f, 4.13397f),
                      Vector3(11.6635f, 10.9563f, 5.86603f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-12.017f, 12.017f, 5),
                      Vector3(-10.9563f, 10.9563f, 4.13397f),
                      Vector3(-10.9563f, 10.9563f, 5.86603f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(-12.017f, -10.6028f, 5),
                      Vector3(-10.9563f, -11.6635f, 4.13397f),
                      Vector3(-10.9563f, -11.6635f, 5.86603f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Triangle triangle(Vector3(10.6028f, -10.6028f, 5),
                      Vector3(11.6635f, -11.6635f, 4.13397f),
                      Vector3(11.6635f, -11.6635f, 5.86603f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Frustum frustum;
    frustum.Set(
    Vector3(8.95415f, -1.88308f, -7.66308f),
    Vector3(-1.88308f, 8.95415f, -7.66308f),
    Vector3(-1.88308f, 8.95415f, 7.66308f),
    Vector3(8.95415f, -1.88308f, 7.66308f), Vector3(-1.41421f, -5.65685f, -3),
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-0.707107f, 0.707107f, 0),
                      Vector3(0.353553f, -0.353553f, -0.866025f),
                      Vector3(0.353553f, -0.353553f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-0.707107f, 0.707107f, 5.33154f),
                      Vector3(0.353553f, -0.353553f, 4.46551f),
                      Vector3(0.353553f, -0.353553f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-0.707107f, 0.707107f, 7.33154f),
                      Vector3(0.353553f, -0.353553f, 6.46551f),
                      Vector3(0.353553f, -0.353553f, 8.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(2.82843f, 2.82843f, 0),
                      Vector3(3.88909f, 3.88909f, -0.866025f),
                      Vector3(3.88909f, 3.88909f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(4.24264f, 4.24264f, 0),
                      Vector3(5.3033f, 5.3033f, -0.866025f),
                      Vector3(5.3033f, 5.3033f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-3.76997f, 4.76997f, 15.9946f),
                      Vector3(-2.90394f, 3.26997f, 15.9946f),
                      Vector3(-4.63599f, 3.26997f, 15.9946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(6.83663f, 15.3766f, 0),
                      Vector3(7.70266f, 13.8766f, 0),
                      Vector3(5.97061f, 13.8766f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-14.3766f, -5.83663f, 0),
                      Vector3(-13.5105f, -7.33663f, 0),
                      Vector3(-15.2426f, -7.33663f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(3.76997f, -2.76997f, 15.9946f),
                      Vector3(4.63599f, -4.26997f, 15.9946f),
                      Vector3(2.90394f, -4.26997f, 15.9946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(14.3766f, 7.83663f, 0),
                      Vector3(15.2426f, 6.33663f, 0),
                      Vector3(13.5105f, 6.33663f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-6.83663f, -13.3766f, 0),
                      Vector3(-5.97061f, -14.8766f, 0),
                      Vector3(-7.70266f, -14.8766f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(9.8995f, 11.3137f, 5.33154f),
                      Vector3(10.9602f, 10.253f, 4.46551f),
                      Vector3(10.9602f, 10.253f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-12.017f, 12.017f, 5.33154f),
                      Vector3(-10.9563f, 10.9563f, 4.46551f),
                      Vector3(-10.9563f, 10.9563f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-11.3137f, -9.8995f, 5.33154f),
                      Vector3(-10.253f, -10.9602f, 4.46551f),
                      Vector3(-10.253f, -10.9602f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(10.6028f, -10.6028f, 5.33154f),
                      Vector3(11.6635f, -11.6635f, 4.46551f),
                      Vector3(11.6635f, -11.6635f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-8.48147f, 14.1383f, 0),
                      Vector3(-7.42081f, 15.199f, -0.866025f),
                      Vector3(-7.42081f, 15.199f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(2.82843f, 2.82843f, 15.9946f),
                      Vector3(3.88909f, 3.88909f, 15.1286f),
                      Vector3(3.88909f, 3.88909f, 16.8606f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(14.1383f, -8.48147f, 0),
                      Vector3(15.199f, -7.42081f, -0.866025f),
                      Vector3(15.199f, -7.42081f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-15.5525f, 7.06726f, 0),
                      Vector3(-14.4919f, 8.12792f, -0.866025f),
                      Vector3(-14.4919f, 8.12792f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(-4.24264f, -4.24264f, 15.9946f),
                      Vector3(-3.18198f, -3.18198f, 15.1286f),
                      Vector3(-3.18198f, -3.18198f, 16.8606f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Triangle triangle(Vector3(7.06726f, -15.5525f, 0),
                      Vector3(8.12792f, -14.4919f, -0.866025f),
                      Vector3(8.12792f, -14.4919f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(-8.95415f, -1.88308f, 7.66308f),
    Vector3(1.88308f, 8.95415f, 7.66308f),
    Vector3(1.88308f, 8.95415f, -7.66308f), Vector3(1.41421f, -5.65685f, -3),
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-0.707107f, -0.707107f, 0),
                      Vector3(0.353553f, 0.353553f, -0.866025f),
                      Vector3(0.353553f, 0.353553f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-3.53553f, 4.53553f, 0),
                      Vector3(-2.66951f, 3.03553f, 0),
                      Vector3(-4.40156f, 3.03553f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-4.94975f, 5.94975f, 0),
                      Vector3(-4.08372f, 4.44975f, 0),
                      Vector3(-5.81577f, 4.44975f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(10.6028f, 12.017f, 5.33154f),
                      Vector3(11.6635f, 10.9563f, 4.46551f),
                      Vector3(11.6635f, 10.9563f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-11.3137f, 11.3137f, 5.33154f),
                      Vector3(-10.253f, 10.253f, 4.46551f),
                      Vector3(-10.253f, 10.253f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-12.017f, -10.6028f, 5.33154f),
                      Vector3(-10.9563f, -11.6635f, 4.46551f),
                      Vector3(-10.9563f, -11.6635f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(9.8995f, -9.8995f, 5.33154f),
                      Vector3(10.9602f, -10.9602f, 4.46551f),
                      Vector3(10.9602f, -10.9602f, 6.19756f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-7.54374f, 13.6695f, 0),
                      Vector3(-6.48308f, 14.7301f, -0.866025f),
                      Vector3(-6.48308f, 14.7301f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(3.06286f, 3.06286f, 15.9946f),
                      Vector3(4.12352f, 4.12352f, 15.1286f),
                      Vector3(4.12352f, 4.12352f, 16.8606f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(13.6695f, -7.54374f, 0),
                      Vector3(14.7301f, -6.48308f, -0.866025f),
                      Vector3(14.7301f, -6.48308f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-15.0837f, 6.12953f, 0),
                      Vector3(-14.023f, 7.19019f, -0.866025f),
                      Vector3(-14.023f, 7.19019f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-4.47707f, -4.47707f, 15.9946f),
                      Vector3(-3.41641f, -3.41641f, 15.1286f),
                      Vector3(-3.41641f, -3.41641f, 16.8606f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(6.12953f, -15.0837f, 0),
                      Vector3(7.19019f, -14.023f, -0.866025f),
                      Vector3(7.19019f, -14.023f, 0.866025f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-3.53553f, 4.53553f, 15.9946f),
                      Vector3(-2.66951f, 3.03553f, 15.9946f),
                      Vector3(-4.40156f, 3.03553f, 15.9946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(7.77437f, 15.8454f, 0),
                      Vector3(8.64039f, 14.3454f, 0),
                      Vector3(6.90834f, 14.3454f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-14.8454f, -6.77437f, 0),
                      Vector3(-13.9794f, -8.27437f, 0),
                      Vector3(-15.7115f, -8.27437f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(3.53553f, -2.53553f, 15.9946f),
                      Vector3(4.40156f, -4.03553f, 15.9946f),
                      Vector3(2.66951f, -4.03553f, 15.9946f));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(14.8454f, 8.77437f, 0),
                      Vector3(15.7115f, 7.27437f, 0),
                      Vector3(13.9794f, 7.27437f, 0));
                            ...
                            FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Triangle triangle(Vector3(-7.77437f, -13.8454f, 0),
                      Vector3(-6.90834f, -15.3454f, 0),
                      Vector3(-8.64039f, -15.3454f, 0));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(4.83154f, 15.4946f, -0.5f),
              Vector3(5.83154f, 16.4946f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(4.83154f, -16.4946f, -0.5f),
              Vector3(5.83154f, -15.4946f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(4.83154f, -0.5f, -15.5f),
              Vector3(5.83154f, 0.5f, -14.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-5.83154f, 15.4946f, -0.5f),
              Vector3(-4.83154f, 16.4946f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-5.83154f, -16.4946f, -0.5f),
              Vector3(-4.83154f, -15.4946f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-5.83154f, -0.5f, 14.5f),
              Vector3(-4.83154f, 0.5f, 15.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-5.83154f, -0.5f, -15.5f),
              Vector3(-4.83154f, 0.5f, -14.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-0.5f, 4.83154f, -15.5f),
              Vector3(0.5f, 5.83154f, -14.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(15.4946f, 4.83154f, -0.5f),
              Vector3(16.4946f, 5.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-16.4946f, 4.83154f, -0.5f),
              Vector3(-15.4946f, 5.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-0.5f, -5.83154f, 14.5f),
              Vector3(0.5f, -4.83154f, 15.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-0.5f, -5.83154f, -15.5f),
              Vector3(0.5f, -4.83154f, -14.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(15.4946f, -5.83154f, -0.5f),
              Vector3(16.4946f, -4.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-16.4946f, -5.83154f, -0.5f),
              Vector3(-15.4946f, -4.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-16.4946f, -0.5f, -5.5f),
              Vector3(-15.4946f, 0.5f, -4.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, -7.66308f, 5),
                ...
                Vector3(-7.66308f, 7.66308f, 5), Vector3(-3, -3, -5),
                Vector3(3, -3, -5), Vector3(3, 3, -5), Vector3(-3, 3, -5));
    Aabb aabb(Vector3(-0.5f, -16.4946f, -5.5f),
              Vector3(0.5f, -15.4946f, -4.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, 4.83154f, 15.4946f),
              Vector3(0.5f, 5.83154f, 16.4946f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, 4.83154f, -16.4946f),
              Vector3(0.5f, 5.83154f, -15.4946f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-15.5f, 4.83154f, -0.5f),
              Vector3(-14.5f, 5.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, -5.83154f, 15.4946f),
              Vector3(0.5f, -4.83154f, 16.4946f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, -5.83154f, -16.4946f),
              Vector3(0.5f, -4.83154f, -15.4946f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(14.5f, -5.83154f, -0.5f),
              Vector3(15.5f, -4.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-15.5f, -5.83154f, -0.5f),
              Vector3(-14.5f, -4.83154f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-15.5f, -0.5f, 4.83154f),
              Vector3(-14.5f, 0.5f, 5.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, 15.4946f, 4.83154f),
              Vector3(0.5f, 16.4946f, 5.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, -16.4946f, 4.83154f),
              Vector3(0.5f, -15.4946f, 5.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(14.5f, -0.5f, -5.83154f),
              Vector3(15.5f, 0.5f, -4.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-15.5f, -0.5f, -5.83154f),
              Vector3(-14.5f, 0.5f, -4.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, 15.4946f, -5.83154f),
              Vector3(0.5f, 16.4946f, -4.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-0.5f, -16.4946f, -5.83154f),
              Vector3(0.5f, -15.4946f, -4.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-5.5f, -16.4946f, -0.5f),
              Vector3(-4.5f, -15.4946f, 0.5f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(5, -7.66308f, -7.66308f),
                ...
                Vector3(5, -7.66308f, 7.66308f), Vector3(-5, -3, -3),
                Vector3(-5, 3, -3), Vector3(-5, 3, 3), Vector3(-5, -3, 3));
    Aabb aabb(Vector3(-5.5f, -0.5f, -16.4946f),
              Vector3(-4.5f, 0.5f, -15.4946f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(15.4946f, -0.5f, 4.83154f),
              Vector3(16.4946f, 0.5f, 5.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-16.4946f, -0.5f, 4.83154f),
              Vector3(-15.4946f, 0.5f, 5.83154f));
                       ...
                       FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-0.5f, -15.5f, 4.83154f),
              Vector3(0.5f, -14.5f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(15.4946f, -0.5f, -5.83154f),
              Vector3(16.4946f, 0.5f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-16.4946f, -0.5f, -5.83154f),
              Vector3(-15.4946f, 0.5f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-0.5f, 14.5f, -5.83154f),
              Vector3(0.5f, 15.5f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-0.5f, -15.5f, -5.83154f),
              Vector3(0.5f, -14.5f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(4.83154f, -15.5f, -0.5f),
              Vector3(5.83154f, -14.5f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(4.83154f, -0.5f, 15.4946f),
              Vector3(5.83154f, 0.5f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(4.83154f, -0.5f, -16.4946f),
              Vector3(5.83154f, 0.5f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-5.83154f, 14.5f, -0.5f),
              Vector3(-4.83154f, 15.5f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-5.83154f, -15.5f, -0.5f),
              Vector3(-4.83154f, -14.5f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-5.83154f, -0.5f, 15.4946f),
              Vector3(-4.83154f, 0.5f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-5.83154f, -0.5f, -16.4946f),
              Vector3(-4.83154f, 0.5f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-0.5f, -5.5f, -16.4946f),
              Vector3(0.5f, -4.5f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    frustum.Set(Vector3(-7.66308f, 5, -7.66308f),
                ...
                Vector3(7.66308f, 5, -7.66308f), Vector3(-3, -5, -3),
                Vector3(-3, -5, 3), Vector3(3, -5, 3), Vector3(3, -5, -3));
    Aabb aabb(Vector3(-16.4946f, -5.5f, -0.5f),
              Vector3(-15.4946f, -4.5f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(4.26997f, 4.26997f, -0.5f),
              Vector3(5.26997f, 5.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-5.26997f, -5.26997f, -0.5f),
              Vector3(-4.26997f, -4.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-5.26997f, 4.26997f, -0.5f),
              Vector3(-4.26997f, 5.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(4.26997f, -5.26997f, -0.5f),
              Vector3(5.26997f, -4.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(3.26997f, 3.26997f, -0.5f),
              Vector3(4.26997f, 4.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-4.26997f, -4.26997f, -0.5f),
              Vector3(-3.26997f, -3.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-4.26997f, 3.26997f, -0.5f),
              Vector3(-3.26997f, 4.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(3.26997f, -4.26997f, -0.5f),
              Vector3(4.26997f, -3.26997f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-8.03993f, 14.5799f, -0.5f),
              Vector3(-7.03993f, 15.5799f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(14.5799f, -8.03993f, -0.5f),
              Vector3(15.5799f, -7.03993f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(3.26997f, 3.26997f, 14.5f),
              Vector3(4.26997f, 4.26997f, 15.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(3.26997f, 3.26997f, -15.5f),
              Vector3(4.26997f, 4.26997f, -14.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-15.5799f, 7.03993f, -0.5f),
              Vector3(-14.5799f, 8.03993f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(7.03993f, -15.5799f, -0.5f),
              Vector3(8.03993f, -14.5799f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-4.26997f, -4.26997f, 14.5f),
              Vector3(-3.26997f, -3.26997f, 15.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-4.26997f, -4.26997f, -15.5f),
              Vector3(-3.26997f, -3.26997f, -14.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-4.26997f, 3.26997f, 14.5f),
              Vector3(-3.26997f, 4.26997f, 15.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-4.26997f, 3.26997f, -15.5f),
              Vector3(-3.26997f, 4.26997f, -14.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(7.03993f, 14.5799f, -0.5f),
              Vector3(8.03993f, 15.5799f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-15.5799f, -8.03993f, -0.5f),
              Vector3(-14.5799f, -7.03993f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(3.26997f, -4.26997f, 14.5f),
              Vector3(4.26997f, -3.26997f, 15.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(3.26997f, -4.26997f, -15.5f),
              Vector3(4.26997f, -3.26997f, -14.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(14.5799f, 7.03993f, -0.5f),
              Vector3(15.5799f, 8.03993f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-8.03993f, -15.5799f, -0.5f),
              Vector3(-7.03993f, -14.5799f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(10.8099f, 10.8099f, 4.5f),
              Vector3(11.8099f, 11.8099f, 5.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-11.8099f, -11.8099f, 4.5f),
              Vector3(-10.8099f, -10.8099f, 5.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-11.8099f, 10.8099f, 4.5f),
              Vector3(-10.8099f, 11.8099f, 5.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(10.8099f, -11.8099f, 4.5f),
              Vector3(11.8099f, -10.8099f, 5.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(10.8099f, 10.8099f, -5.5f),
              Vector3(11.8099f, 11.8099f, -4.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-11.8099f, -11.8099f, -5.5f),
              Vector3(-10.8099f, -10.8099f, -4.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(-11.8099f, 10.8099f, -5.5f),
              Vector3(-10.8099f, 11.8099f, -4.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(2.38419e-07f, -4.24264f, -5), Vector3(4.24264f, -2.38419e-07f, -5),
    Vector3(-2.38419e-07f, 4.24264f, -5), Vector3(-4.24264f, 2.38419e-07f, -5));
    Aabb aabb(Vector3(10.8099f, -11.8099f, -5.5f),
              Vector3(11.8099f, -10.8099f, -4.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(4.03553f, 4.03553f, -0.5f),
              Vector3(5.03553f, 5.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-5.03553f, -5.03553f, -0.5f),
              Vector3(-4.03553f, -4.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(3.03553f, 3.03553f, -0.5f),
              Vector3(4.03553f, 4.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-4.03553f, -4.03553f, -0.5f),
              Vector3(-3.03553f, -3.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-4.26997f, 3.26997f, 15.4946f),
              Vector3(-3.26997f, 4.26997f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-4.26997f, 3.26997f, -16.4946f),
              Vector3(-3.26997f, 4.26997f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(6.33663f, 13.8766f, -0.5f),
              Vector3(7.33663f, 14.8766f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-14.8766f, -7.33663f, -0.5f),
              Vector3(-13.8766f, -6.33663f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(3.26997f, -4.26997f, 15.4946f),
              Vector3(4.26997f, -3.26997f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(3.26997f, -4.26997f, -16.4946f),
              Vector3(4.26997f, -3.26997f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(13.8766f, 6.33663f, -0.5f),
              Vector3(14.8766f, 7.33663f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-7.33663f, -14.8766f, -0.5f),
              Vector3(-6.33663f, -13.8766f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(10.1066f, 10.1066f, 4.83154f),
              Vector3(11.1066f, 11.1066f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-11.1066f, -11.1066f, 4.83154f),
              Vector3(-10.1066f, -10.1066f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-11.8099f, 10.8099f, 4.83154f),
              Vector3(-10.8099f, 11.8099f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(10.8099f, -11.8099f, 4.83154f),
              Vector3(11.8099f, -10.8099f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(10.1066f, 10.1066f, -5.83154f),
              Vector3(11.1066f, 11.1066f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-11.1066f, -11.1066f, -5.83154f),
              Vector3(-10.1066f, -10.1066f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-11.8099f, 10.8099f, -5.83154f),
              Vector3(-10.8099f, 11.8099f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(10.8099f, -11.8099f, -5.83154f),
              Vector3(11.8099f, -10.8099f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-8.27437f, 14.3454f, -0.5f),
              Vector3(-7.27437f, 15.3454f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(14.3454f, -8.27437f, -0.5f),
              Vector3(15.3454f, -7.27437f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(3.03553f, 3.03553f, 15.4946f),
              Vector3(4.03553f, 4.03553f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(3.03553f, 3.03553f, -16.4946f),
              Vector3(4.03553f, 4.03553f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-15.3454f, 7.27437f, -0.5f),
              Vector3(-14.3454f, 8.27437f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(7.27437f, -15.3454f, -0.5f),
              Vector3(8.27437f, -14.3454f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-4.03553f, -4.03553f, 15.4946f),
              Vector3(-3.03553f, -3.03553f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-4.03553f, -4.03553f, -16.4946f),
              Vector3(-3.03553f, -3.03553f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(3.58553f, 3.58553f, -0.5f),
              Vector3(4.58553f, 4.58553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(2.48553f, 2.48553f, -0.5f),
              Vector3(3.48553f, 3.48553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-4.58553f, -4.58553f, -0.5f),
              Vector3(-3.58553f, -3.58553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(-5.65685f, -1.41421f, -3), Vector3(-5.65685f, -1.41421f, 3),
    Vector3(-1.41421f, -5.65685f, 3));
    Aabb aabb(Vector3(-3.48553f, -3.48553f, -0.5f),
              Vector3(-2.48553f, -2.48553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-5.03553f, 4.03553f, -0.5f),
              Vector3(-4.03553f, 5.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(4.03553f, -5.03553f, -0.5f),
              Vector3(5.03553f, -4.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-4.03553f, 3.03553f, -0.5f),
              Vector3(-3.03553f, 4.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(3.03553f, -4.03553f, -0.5f),
              Vector3(4.03553f, -3.03553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(10.8099f, 10.8099f, 4.83154f),
              Vector3(11.8099f, 11.8099f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-11.8099f, -11.8099f, 4.83154f),
              Vector3(-10.8099f, -10.8099f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-11.1066f, 10.1066f, 4.83154f),
              Vector3(-10.1066f, 11.1066f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(10.1066f, -11.1066f, 4.83154f),
              Vector3(11.1066f, -10.1066f, 5.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(10.8099f, 10.8099f, -5.83154f),
              Vector3(11.8099f, 11.8099f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-11.8099f, -11.8099f, -5.83154f),
              Vector3(-10.8099f, -10.8099f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-11.1066f, 10.1066f, -5.83154f),
              Vector3(-10.1066f, 11.1066f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(10.1066f, -11.1066f, -5.83154f),
              Vector3(11.1066f, -10.1066f, -4.83154f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-7.33664f, 13.8766f, -0.5f),
              Vector3(-6.33664f, 14.8766f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(13.8766f, -7.33664f, -0.5f),
              Vector3(14.8766f, -6.33664f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(3.26997f, 3.26997f, 15.4946f),
              Vector3(4.26997f, 4.26997f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(3.26997f, 3.26997f, -16.4946f),
              Vector3(4.26997f, 4.26997f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-14.8766f, 6.33664f, -0.5f),
              Vector3(-13.8766f, 7.33664f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(6.33664f, -14.8766f, -0.5f),
              Vector3(7.33664f, -13.8766f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-4.26997f, -4.26997f, 15.4946f),
              Vector3(-3.26997f, -3.26997f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-4.26997f, -4.26997f, -16.4946f),
              Vector3(-3.26997f, -3.26997f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-4.03553f, 3.03553f, 15.4946f),
              Vector3(-3.03553f, 4.03553f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-4.03553f, 3.03553f, -16.4946f),
              Vector3(-3.03553f, 4.03553f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(7.27437f, 14.3454f, -0.5f),
              Vector3(8.27437f, 15.3454f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-15.3454f, -8.27437f, -0.5f),
              Vector3(-14.3454f, -7.27437f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(3.03553f, -4.03553f, 15.4946f),
              Vector3(4.03553f, -3.03553f, 16.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(3.03553f, -4.03553f, -16.4946f),
              Vector3(4.03553f, -3.03553f, -15.4946f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(14.3454f, 7.27437f, -0.5f),
              Vector3(15.3454f, 8.27437f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-8.27437f, -15.3454f, -0.5f),
              Vector3(-7.27437f, -14.3454f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-4.58553f, 3.58553f, -0.5f),
              Vector3(-3.58553f, 4.58553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(-3.48553f, 2.48553f, -0.5f),
              Vector3(-2.48553f, 3.48553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(3.58553f, -4.58553f, -0.5f),
              Vector3(4.58553f, -3.58553f, 0.5f));
                        ...
                        FILE* file = nullptr)
{
    ...
    Vector3(1.41421f, -5.65685f, 3), Vector3(5.65685f, -1.41421f, 3),
    Vector3(5.65685f, -1.41421f, -3));
    Aabb aabb(Vector3(2.48553f, -3.48553f, -0.5f),
              Vector3(3.48553f, -2.48553f, 0.5f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-1, -1, -0.5f),
               Vector3(2.98023e-08f, 2.98023e-08f, 0.5f));
    Aabb aabb1(Vector3(-2.98023e-08f, -2.98023e-08f, -0.5f),
               Vector3(1, 1, 0.5f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-2.98023e-08f, -2.98023e-08f, -0.5f),
               Vector3(1, 1, 0.5f));
    Aabb aabb1(Vector3(-1, -1, -0.5f),
               Vector3(2.98023e-08f, 2.98023e-08f, 0.5f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-1, -0.5f, -1),
               Vector3(2.98023e-08f, 0.5f, 2.98023e-08f));
    Aabb aabb1(Vector3(-2.98023e-08f, -0.5f, -2.98023e-08f),
               Vector3(1, 0.5f, 1));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-2.98023e-08f, -0.5f, -2.98023e-08f),
               Vector3(1, 0.5f, 1));
    Aabb aabb1(Vector3(-1, -0.5f, -1),
               Vector3(2.98023e-08f, 0.5f, 2.98023e-08f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-0.5f, -1, -1),
               Vector3(0.5f, 2.98023e-08f, 2.98023e-08f));
    Aabb aabb1(Vector3(-0.5f, -2.98023e-08f, -2.98023e-08f),
               Vector3(0.5f, 1, 1));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-0.5f, -2.98023e-08f, -2.98023e-08f),
               Vector3(0.5f, 1, 1));
    Aabb aabb1(Vector3(-0.5f, -1, -1),
               Vector3(0.5f, 2.98023e-08f, 2.98023e-08f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-1, -1, -0.1f),
               Vector3(2.98023e-08f, 2.98023e-08f, 0.1f));
    Aabb aabb1(Vector3(-2.98023e-08f, -2.98023e-08f, -0.1f),
               Vector3(1, 1, 0.1f));
                    ...
                    FILE* file = nullptr)
{
    ...
    Aabb aabb0(Vector3(-2.98023e-08f, -2.98023e-08f, -0.1f),
               Vector3(1, 1, 0.1f));
    Aabb aabb1(Vector3(-1, -1, -0.1f),
               Vector3(2.98023e-08f, 2.98023e-08f, 0.1f));
