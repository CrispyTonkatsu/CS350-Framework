...
namespace Math
{
    ...
    //---------------------------------------------------------------------
    //Matrix 3
    /// 3 dimensional square matrix. Supports operations with other 3
    /// dimensional square matrices, 2 dimensional vectors, and 3 dimensional
    /// vectors.
    struct Matrix3
    {
#ifdef ColumnBasis
        using BasisVector = Vector3;
        using CrossVector = Vec3Param;
#else
        ...
        void BuildTransform(Vec2Param translate, float radians,
                            Vec2Param scale);
    ...
    /// Transforms the given vector by the matrix as if the matrix was
    /// transposed.
